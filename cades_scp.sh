...
# scp -r data/processed/biolog/features_reduced cloud-cades:/datax/dkishore/trait-prediction/data/processed/biolog/
# scp -r data/processed/biolog/phenotypes/ cloud-cades:/datax/dkishore/trait-prediction/data/processed/biolog/
